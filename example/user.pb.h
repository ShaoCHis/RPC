...
template<> ::protobuf::RegisterRequest* Arena::CreateMaybeMessage<::protobuf::RegisterRequest>(Arena*);
template<> ::protobuf::RegisterResponse* Arena::CreateMaybeMessage<::protobuf::RegisterResponse>(Arena*);
...
class RegisterRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.RegisterRequest) */ {
 public:
  RegisterRequest();
...
class RegisterResponse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.RegisterResponse) */ {
 public:
  RegisterResponse();
...
inline ::protobuf::ResultCode* LoginResponse::_internal_mutable_result() {
  ...
  if (result_ == nullptr) {
    auto* p = CreateMaybeMessage<::protobuf::ResultCode>(GetArenaNoVirtual());
    result_ = p;
  }
  return result_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterRequest::id() const {
  // @@protoc_insertion_point(field_get:protobuf.RegisterRequest.id)
  return _internal_id();
}
...
inline void RegisterRequest::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:protobuf.RegisterRequest.id)
}
...
inline const std::string& RegisterRequest::name() const {
  // @@protoc_insertion_point(field_get:protobuf.RegisterRequest.name)
  return _internal_name();
}
inline void RegisterRequest::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:protobuf.RegisterRequest.name)
}
inline std::string* RegisterRequest::mutable_name() {
  // @@protoc_insertion_point(field_mutable:protobuf.RegisterRequest.name)
  return _internal_mutable_name();
}
...
inline void RegisterRequest::set_name(std::string&& value) {
  ...
  name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:protobuf.RegisterRequest.name)
}
inline void RegisterRequest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protobuf.RegisterRequest.name)
}
inline void RegisterRequest::set_name(const void* value, size_t size) {
  
  name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protobuf.RegisterRequest.name)
}
...
inline std::string* RegisterRequest::release_name() {
  // @@protoc_insertion_point(field_release:protobuf.RegisterRequest.name)
...
inline void RegisterRequest::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name);
  // @@protoc_insertion_point(field_set_allocated:protobuf.RegisterRequest.name)
}
...
inline const std::string& RegisterRequest::pwd() const {
  // @@protoc_insertion_point(field_get:protobuf.RegisterRequest.pwd)
  return _internal_pwd();
}
inline void RegisterRequest::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:protobuf.RegisterRequest.pwd)
}
inline std::string* RegisterRequest::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:protobuf.RegisterRequest.pwd)
  return _internal_mutable_pwd();
}
...
inline void RegisterRequest::set_pwd(std::string&& value) {
  ...
  pwd_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:protobuf.RegisterRequest.pwd)
}
inline void RegisterRequest::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:protobuf.RegisterRequest.pwd)
}
inline void RegisterRequest::set_pwd(const void* value, size_t size) {
  
  pwd_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:protobuf.RegisterRequest.pwd)
}
...
inline std::string* RegisterRequest::release_pwd() {
  // @@protoc_insertion_point(field_release:protobuf.RegisterRequest.pwd)
...
inline void RegisterRequest::set_allocated_pwd(std::string* pwd) {
  ...
  pwd_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd);
  // @@protoc_insertion_point(field_set_allocated:protobuf.RegisterRequest.pwd)
}
...
inline const ::protobuf::ResultCode& RegisterResponse::_internal_result() const {
  const ::protobuf::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::protobuf::ResultCode*>(
      &::protobuf::_ResultCode_default_instance_);
}
inline const ::protobuf::ResultCode& RegisterResponse::result() const {
  // @@protoc_insertion_point(field_get:protobuf.RegisterResponse.result)
  return _internal_result();
}
inline ::protobuf::ResultCode* RegisterResponse::release_result() {
  // @@protoc_insertion_point(field_release:protobuf.RegisterResponse.result)
  
  ::protobuf::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::protobuf::ResultCode* RegisterResponse::_internal_mutable_result() {
...
inline ::protobuf::ResultCode* RegisterResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:protobuf.RegisterResponse.result)
  return _internal_mutable_result();
}
inline void RegisterResponse::set_allocated_result(::protobuf::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:protobuf.RegisterResponse.result)
}
...
inline bool RegisterResponse::sucess() const {
  // @@protoc_insertion_point(field_get:protobuf.RegisterResponse.sucess)
  return _internal_sucess();
}
...
inline void RegisterResponse::set_sucess(bool value) {
  _internal_set_sucess(value);
  // @@protoc_insertion_point(field_set:protobuf.RegisterResponse.sucess)
}
